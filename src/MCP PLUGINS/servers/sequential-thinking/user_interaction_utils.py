# -*- coding: utf-8 -*-
"""
User interaction utilities for Sequential Thinking MCP plugin.
Simplified version for problem-solving clarifications.
"""
import asyncio
import time
import uuid
...
def create_ask_user_tool(
    ...
    """Create the ask_user tool for Sequential Thinking agent clarifications.
    ...
    return FunctionTool(
        ask_user_impl,
        description="Ask the user a clarification question about the problem or requirements"
    )
