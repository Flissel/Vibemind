"""
Sequential Thinking UI Server for Event Streaming
"""
import asyncio
import json
import os
...
async def start_thinking_ui_server(session_id: str, event_port: int):
    """
    Start a minimal UI server for Sequential Thinking event streaming
    ...
    print(f"Sequential Thinking UI server started on http://127.0.0.1:{ui_port}", file=sys.stderr)
